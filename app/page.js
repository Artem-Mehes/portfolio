    ...
    <div className="flex min-h-screen">
      <header className="p-16 bg-gray-950 flex flex-col gap-20 sticky top-0 max-h-screen border-r border-r-gray-700">
        <div className="flex flex-col gap-10">
          <div className="flex gap-6 items-center">
            ...
            />
            <h1 className="scroll-m-20 text-slate-300 text-2xl font-extrabold tracking-tight lg:text-4xl font-robotoMono">
              Artem Mehes
            </h1>
          </div>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-2">
              <h2 className="scroll-m-20 text-slate-300 text-xl font-semibold tracking-tight first:mt-0">
            ...
            <a
              href="/cv.pdf"
              target="_blank"
              className="flex gap-1 items-center text-slate-300 font-medium group w-fit hover:text-teal-300"
            >
              View Resume
              <LuArrowUpRight
                size={22}
      ...
      <div className="flex flex-col w-full gap-10">
        ...
        <footer className="p-3 bg-slate-800 text-center">
          Built with{" "}
          <span className="font-semibold text-teal-300">Next.js</span> and{" "}
          <span className="font-semibold text-teal-300">Tailwind CSS</span>,
          deployed with{" "}
          <span className="font-semibold text-teal-300">Vercel</span>
        </footer>
      </div>
    </div>
  );
